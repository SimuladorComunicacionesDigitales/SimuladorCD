"""
Esta clase contiene la ventana de resultados para Señales No Convencionales - 2 Símbolos.
"""
...
class ScreenSimbolos2(QMainWindow):
    def __init__(self, widget,frameSizeWidth, frameSizeHeight, fSample, nTotalSimb, sizeHeight):
        ...
        """
        super(ScreenSimbolos2, self).__init__()
        loadUi("UIs\SenalesNC_Simb_2S.ui", self)
