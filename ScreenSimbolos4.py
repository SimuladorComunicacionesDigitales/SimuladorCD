"""
Esta clase contiene la ventana de resultados para Señales No Convencionales - 4 Símbolos.
"""
...
class ScreenSimbolos4(QMainWindow):
    def __init__(self, widget,frameSizeWidth, frameSizeHeight, fSample, nTotalSimb, sizeHeight):
        ...
        """
        super(ScreenSimbolos4, self).__init__()
        loadUi("UIs\SenalesNC_Simb_4S.ui", self)
        self.widget = widget
        ...
        # Actualizar valor de tSimb
        self.sbTsimb.valueChanged.connect(self.spinBoxInt)
        self.hsTsimb.valueChanged.connect(self.sliderFloat)

        # Simbolo por default S2
        self.cbSimb2.setCurrentIndex(1)
        self.cbSimb3.setCurrentIndex(1)

        # Valor por default amplitud y fase en S1, S2, S3
        self.leAmpS1.setText("1")
        self.leAmpS2.setText("-1")
        self.leAmpS3.setText("-2")
        self.leAmpS4.setText("1")

        self.leFaseS1.setText("0")
        self.leFaseS2.setText("0")
        self.leFaseS3.setText("0")
        self.leFaseS4.setText("0")

        self.leAmpS4.setEnabled(False)
        self.leAmpS4.setStyleSheet("QLineEdit{\n"
        ...
        self.leFaseS3.setEnabled(False)
        self.leFaseS3.setStyleSheet("QLineEdit{\n"
                                    "    background-color: rgb(217, 217, 217);\n"
                                    "    border: 2px solid black;\n"
                                    "}")

        self.leFaseS4.setEnabled(False)
        self.leFaseS4.setStyleSheet("QLineEdit{\n"
                                    "    background-color: rgb(217, 217, 217);\n"
                                    "    border: 2px solid black;\n"
                                    "}")

        # Valor por default en indicador FSimb
        self.leFsimb.setReadOnly(True)
        self.leFsimb.setText("10")

        # Horizontal sliders para las frecuencias de portadora
        ...
        self.hsFreqS3.setEnabled(False)
        self.hsFreqS3.setStyleSheet("""
                                                    QSlider{
                                                        background-color: transparent;
                                                        padding: 2px;
                                                    }
        ...
        self.hsFreqS4.setEnabled(False)
        self.hsFreqS4.setStyleSheet("""
                                                    QSlider{
                                                        background-color: transparent;
                                                        padding: 2px;
                                                    }
        ...
        # SpinBox par la frecuencia de portadora
        ...
        self.sbFreqS3.setEnabled(False)
        self.sbFreqS3.setStyleSheet("""QSpinBox{
                                                            background-color: rgb(217, 217, 217);
                                                            qproperty-alignment: AlignCenter;
                                                        }       
                                                    """)

        self.sbFreqS4.setEnabled(False)
        self.sbFreqS4.setStyleSheet("""QSpinBox{
                                                            background-color: rgb(217, 217, 217);
                                                            qproperty-alignment: AlignCenter;
                                                        }       
                                                    """)

        # ComboBoxes para inicio y duracion de simbolo
        ...
        self.cbT1S3.setEnabled(False)
        self.cbT1S3.setStyleSheet("QComboBox{\n"
                                  "    background: rgb(217, 217, 217);\n"
                                  "    color: black;\n"
                                  "    border: 2px solid black;\n"
                                  "    font-size: 15px;\n"
                                  "}")
        self.cbT2S3.setEnabled(False)
        self.cbT2S3.setStyleSheet("QComboBox{\n"
                                  "    background: rgb(217, 217, 217);\n"
                                  "    color: black;\n"
                                  "    border: 2px solid black;\n"
                                  "    font-size: 15px;\n"
        ...
        self.cbT1S4.setEnabled(False)
        self.cbT1S4.setStyleSheet("QComboBox{\n"
                                  "    background: rgb(217, 217, 217);\n"
                                  "    color: black;\n"
                                  "    border: 2px solid black;\n"
                                  "    font-size: 15px;\n"
                                  "}")
        self.cbT2S4.setEnabled(False)
        self.cbT2S4.setStyleSheet("QComboBox{\n"
                                  "    background: rgb(217, 217, 217);\n"
                                  "    color: black;\n"
                                  "    border: 2px solid black;\n"
                                  "    font-size: 15px;\n"
        ...
        self.cbSimb3.currentTextChanged.connect(self.hideDataS3)
        self.cbSimb4.currentTextChanged.connect(self.hideDataS4)
        ...
        self.cbT1S3.setItemData(0, ["25%", "50%", "75%"])
        self.cbT1S3.setItemData(1, ["25%", "50%", "75%"])
        self.cbT1S3.setItemData(2, ["25%", "50%"])
        self.cbT1S3.setItemData(3, ["25%"])

        self.cbT1S4.setItemData(0, ["25%", "50%", "75%"])
        self.cbT1S4.setItemData(1, ["25%", "50%", "75%"])
        self.cbT1S4.setItemData(2, ["25%", "50%"])
        self.cbT1S4.setItemData(3, ["25%"])
        ...
        self.leXS3.setReadOnly(True)
        self.leYS3.setReadOnly(True)

        self.leXS4.setReadOnly(True)
        self.leYS4.setReadOnly(True)
        ...
        self.cbT1S3.activated.connect(self.tiemposInicioDuracionS3)
        self.cbT1S4.activated.connect(self.tiemposInicioDuracionS4)
    ...
    def mensaje_errorBases(self):
        """
        Definición de PopUpWindow para notificar que se ingresó una señal con más de dos bases.
        """
        msg = QMessageBox()
        msg.setWindowTitle("¡Error!")
        msg.setText("Has ingresado una señal con más de dos bases.")
        msg.setIcon(QMessageBox.Warning)
        msg.setDefaultButton(QMessageBox.Ok)
        x = msg.exec_()
    ...
    def mensaje_errorSimbsIguales(self):
        ...
        msg = QMessageBox()
        msg.setWindowTitle("¡Error!")
        msg.setText("Has ingresado símbolos iguales.")
        msg.setIcon(QMessageBox.Warning)
        msg.setDefaultButton(QMessageBox.Ok)
        x = msg.exec_()
    ...
    def tiemposInicioDuracionS1(self, index):
        """
        Para S1. Esta función actualiza las opciones de Duración de los símbolos de duración variable según el instante de inicio.
    ...
    def tiemposInicioDuracionS2(self, index):
        """
        Para S2. Esta función actualiza las opciones de Duración de los símbolos de duración variable según el instante de inicio.
    ...
    def tiemposInicioDuracionS3(self, index):
        """
        Para S3. Esta función actualiza las opciones de Duración de los símbolos de duración variable según el instante de inicio.

        :param index:  Instante de inicio.
        """
        self.cbT2S3.clear()
        self.cbT2S3.addItems(self.cbT1S3.itemData(index))

    def tiemposInicioDuracionS4(self, index):
        """
        Para S4. Esta función actualiza las opciones de Duración de los símbolos de duración variable según el instante de inicio.

        :param index:  Instante de inicio.
        """
        self.cbT2S4.clear()
        self.cbT2S4.addItems(self.cbT1S4.itemData(index))

    def hideDataS1(self, tipo):
        """
        Para S1. Esta función habilita o deshabilita los distintos datos a ingresar según el símbolo seleccionado.
    ...
    def hideDataS2(self, tipo):
        """
        Para S2. Esta función habilita o deshabilita los distintos datos a ingresar según el símbolo seleccionado.

        :param tipo: Opción de Símbolo seleccionada con el ComboBox
        """
        if tipo != "Pulso nulo":
            self.leAmpS2.setEnabled(True)
            self.leAmpS2.setStyleSheet("QLineEdit{\n"
                                       "    background-color: white;\n"
                                       "    border: 2px solid black;\n"
                                       "}")
        else:
            self.leAmpS2.setEnabled(False)
            self.leAmpS2.setStyleSheet("QLineEdit{\n"
                                       "    background-color: rgb(217, 217, 217);\n"
                                       "    border: 2px solid black;\n"
                                       "}")
    ...
    def hideDataS3(self, tipo):
        """
        Para S3. Esta función habilita o deshabilita los distintos datos a ingresar según el símbolo seleccionado.

        :param tipo: Opción de Símbolo seleccionada con el ComboBox
        """
        if tipo != "Pulso nulo":
            self.leAmpS3.setEnabled(True)
            self.leAmpS3.setStyleSheet("QLineEdit{\n"
                                       "    background-color: white;\n"
                                       "    border: 2px solid black;\n"
                                       "}")
        else:
            self.leAmpS3.setEnabled(False)
            self.leAmpS3.setStyleSheet("QLineEdit{\n"
                                       "    background-color: rgb(217, 217, 217);\n"
                                       "    border: 2px solid black;\n"
                                       "}")
    ...
    def hideDataS4(self, tipo):
        """
        Para S4. Esta función habilita o deshabilita los distintos datos a ingresar según el símbolo seleccionado.

        :param tipo: Opción de Símbolo seleccionada con el ComboBox
        """
        if tipo != "Pulso nulo":
            self.leAmpS4.setEnabled(True)
            self.leAmpS4.setStyleSheet("QLineEdit{\n"
                                       "    background-color: white;\n"
                                       "    border: 2px solid black;\n"
                                       "}")
    ...
    def chequearSimbsIguales(self,s1,s2,s3,s4):
        """
        ...
        if np.allclose(s1,s2):
            return True
        elif np.allclose(s1,s3):
            return True
        elif np.allclose(s1,s4):
            return True
        elif np.allclose(s2,s3):
            return True
        elif np.allclose(s2,s4):
            return True
        elif np.allclose(s3,s4):
            return True
        else:
            return False

    def graficarSimb(self, s1, s2, s3, s4, tSimb, t):
        """
        ...
        s3Graf = np.concatenate((zeroes, s3, zeroes))
        s4Graf = np.concatenate((zeroes, s4, zeroes))
        ...
        if esCoseno(s1, self.fSample):
            ...
            tGraf = np.linspace(-0.001 * tSimb, tSimb * 1.001, tGrafLen)
        ...
        self.axs3.plot(tGraf, s3Graf, 'r', linewidth=3)
        self.axs3.set_title("Símbolo 3", fontsize=self.sizeHeight*0.015, weight = "bold")
        ...
        self.axs4.plot(tGraf, s4Graf, 'r', linewidth=3)
        self.axs4.set_title("Símbolo 4", fontsize=self.sizeHeight*0.015, weight = "bold")
    ...
    def graficarConstAntes(self, s1, s2, s3, s4, U1, U2, tSimb):
        """
        ...
        if not(np.allclose(s1,s1Test)):
            dosBases = False

        if not(np.allclose(s2,s2Test)):
            dosBases = False

        if not(np.allclose(s3,s3Test)):
            dosBases = False

        if not(np.allclose(s4,s4Test)):
            dosBases = False
    ...
    def graficarConstDespues(self, senal, U1, U2, tSimb, coord, nMuestrasSimb):
        ...
        size = np.concatenate((np.full((1, detU1.size), 5), np.full((1, 4), 300)), axis=1)
        z = np.concatenate((np.full((1, detU1.size), 0.5), np.full((1, 4), 0)), axis=1)
    ...
    def simular(self):
        ...
        try:
            ...
            amplitud1 = float(self.leAmpS1.text())
            ...
            amplitud2 = float(self.leAmpS2.text())
            ...
            # Datos S3
            tipoOnda_Opcion3 = self.tipoSenal(self.cbSimb3.currentText())
            tipoOnda3 = tipoOnda_Opcion3

            if tipoOnda_Opcion3 == 4 or tipoOnda_Opcion3 == 6:
                frecuencia3 = self.hsFreqS3.value()
            else:
                frecuencia3 = 0

            fase3 = convertirFase(self.leFaseS3.text())
            amplitud3 = float(self.leAmpS3.text())

            if tipoOnda_Opcion3 == 5 or tipoOnda_Opcion3 == 6:
                t1s3, t2s3, tipoOnda3 = self.inicioDuracion(self.cbT1S3.currentText(), self.cbT2S3.currentText())
            else:
                t1s3, t2s3 = 0, 0

            # Datos S4
            tipoOnda_Opcion4 = self.tipoSenal(self.cbSimb4.currentText())
            tipoOnda4 = tipoOnda_Opcion4

            if tipoOnda_Opcion4 == 4 or tipoOnda_Opcion4 == 6:
                frecuencia4 = self.hsFreqS4.value()
            else:
                frecuencia4 = 0

            fase4 = convertirFase(self.leFaseS4.text())
            amplitud4 = float(self.leAmpS4.text())

            if tipoOnda_Opcion4 == 5 or tipoOnda_Opcion4 == 6:
                t1s4, t2s4, tipoOnda4 = self.inicioDuracion(self.cbT1S4.currentText(), self.cbT2S4.currentText())
            else:
                t1s4, t2s4 = 0, 0
            ...
            s1 = simbolos(t, nMuestrasSimb, tSimb, tipoOnda_Opcion1, frecuencia1, fase1, amplitud1, t1s1, t2s1, self.fSample)
            s2 = simbolos(t, nMuestrasSimb, tSimb, tipoOnda_Opcion2, frecuencia2, fase2, amplitud2, t1s2, t2s2, self.fSample)
            s3 = simbolos(t, nMuestrasSimb, tSimb, tipoOnda_Opcion3, frecuencia3, fase3, amplitud3, t1s3, t2s3, self.fSample)
            s4 = simbolos(t, nMuestrasSimb, tSimb, tipoOnda_Opcion4, frecuencia4, fase4, amplitud4, t1s4, t2s4, self.fSample)

            simbsIguales = self.chequearSimbsIguales(s1,s2,s3,s4)
            ...
            tipoOndas = (tipoOnda1, tipoOnda2, tipoOnda3, tipoOnda4)
            frecuencias = (frecuencia1, frecuencia2, frecuencia3, frecuencia4)
            datos = (self.fSample, nMuestrasSimb, t, nroSimb, tSimb, nivelRuido, self.nTotalSimb)

            U1, U2 = gramSchmidt(s1, s2, s3, s4, nMuestrasSimb, self.fSample)
            senal, t2, bits = senalAleatoria(s1, s2, s3, s4, tSimb, nMuestrasSimb, nroSimb, self.nTotalSimb)

            self.graficarSimb(s1, s2, s3, s4, tSimb, t)
            self.graficarBases(U1, U2, tSimb, t)

            coord, dosBases = self.graficarConstAntes(s1, s2, s3, s4, U1, U2, tSimb)
            ...
            senalDet, rec = deteccionDistancia(coord, s1, s2, s3, s4, nroSimb, detU1, detU2, self.nTotalSimb, nMuestrasSimb)
            ...
            if o_s1s3:
                self.O13.setPixmap(QtGui.QPixmap("UIs/check.png"))
            else:
                self.O13.setPixmap(QtGui.QPixmap("UIs/x.png"))

            if o_s1s4:
                self.O14.setPixmap(QtGui.QPixmap("UIs/check.png"))
            else:
                self.O14.setPixmap(QtGui.QPixmap("UIs/x.png"))

            if o_s2s3:
                self.O23.setPixmap(QtGui.QPixmap("UIs/check.png"))
            else:
                self.O23.setPixmap(QtGui.QPixmap("UIs/x.png"))

            if o_s2s4:
                self.O24.setPixmap(QtGui.QPixmap("UIs/check.png"))
            else:
                self.O24.setPixmap(QtGui.QPixmap("UIs/x.png"))

            if o_s3s4:
                self.O34.setPixmap(QtGui.QPixmap("UIs/check.png"))
            else:
                self.O34.setPixmap(QtGui.QPixmap("UIs/x.png"))
            ...
            if E3.is_integer():
                ...
                self.E3.setText(format(E3, "10.3f"))

            if E4.is_integer():
                self.E4.setText(str(int(E4)))
            else:
                self.E4.setText(format(E4, "10.3f"))
            ...
            if tipoOnda_Opcion3 == 4 or tipoOnda_Opcion3 == 6:
                if numCiclosEnterosS3:
                    self.NumCiclosS3.setPixmap(QtGui.QPixmap("UIs/check.png"))
                else:
                    self.NumCiclosS3.setPixmap(QtGui.QPixmap("UIs/x.png"))
            else:
                self.NumCiclosS3.setPixmap(QtGui.QPixmap("UIs/Empty.png"))

            if tipoOnda_Opcion4 == 4 or tipoOnda_Opcion4 == 6:
                if numCiclosEnterosS4:
                    self.NumCiclosS4.setPixmap(QtGui.QPixmap("UIs/check.png"))
                else:
                    self.NumCiclosS4.setPixmap(QtGui.QPixmap("UIs/x.png"))
            else:
                self.NumCiclosS4.setPixmap(QtGui.QPixmap("UIs/Empty.png"))
            ...
            if x3.is_integer():
                ...
                self.leXS3.setText(format(x3, "10.3f"))

            if y3.is_integer():
                self.leYS3.setText(str(int(y3)))
            else:
                self.leYS3.setText(format(y3, "10.3f"))

            # Coordenadas S4
            if x4.is_integer():
                self.leXS4.setText(str(int(x4)))
            else:
                self.leXS4.setText(format(x4, "10.3f"))

            if y4.is_integer():
                self.leYS4.setText(str(int(y4)))
            else:
                self.leYS4.setText(format(y4, "10.3f"))
