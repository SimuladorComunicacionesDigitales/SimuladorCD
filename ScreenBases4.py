"""
Esta clase contiene la ventana de resultados para Señales No Convencionales - Bases - 4 Símbolos.
"""
...
class ScreenBases4(QMainWindow):
    def __init__(self, widget,frameSizeWidth, frameSizeHeight, fSample, nTotalSimb, sizeHeight):
        ...
        """
        super(ScreenBases4, self).__init__()
        loadUi("UIs\SenalesNC_Bases_4S.ui", self)
        self.widget = widget
    ...
    def graficarSimb(self, s1, s2, s3, s4, tSimb, t):
        ...
        self.axs3.annotate(f'Amplitud: {format(maX, "<10.4f")}', (10, 10 ), xycoords='axes pixels',weight='bold',fontsize=self.sizeHeight*0.01)
        ...
        self.axs4.grid()
        maX = np.amax(abs(s4Graf))
        self.axs4.annotate(f'Amplitud: {format(maX, "<10.4f")}', (10, 10 ), xycoords='axes pixels',weight='bold',fontsize=self.sizeHeight*0.01)
    ...
    def simular(self):
        ...
        try:
            ...
            xS4 = float(self.XS4.text())
            yS4 = float(self.YS4.text())
            ...
            coord = self.graficarConstAntes(s1, s2, s3, s4, U1, U2, tSimb)
            ...
            if math.isclose(factorLambda, 0, abs_tol=0.01):
                ...
                # Coordenadas S4
                if xS4.is_integer():
                    self.leXS4.setText(str(int(xS4)))
                else:
                    self.leXS4.setText(format(xS4, "10.3f"))

                if yS4.is_integer():
                    self.leYS4.setText(str(int(yS4)))
                else:
                    self.leYS4.setText(format(yS4, "10.3f"))
